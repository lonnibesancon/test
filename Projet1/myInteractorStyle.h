...
=========================================================================*/
// .NAME myInteractorStyle - manipulate objects in the scene independent of each other
// .SECTION Description
// myInteractorStyle allows the user to interact with (rotate,
...
public:
  ...
  vtkTypeMacro(myInteractorStyle,vtkInteractorStyle);
...
//  virtual void OnRightButtonUp();
  ...
  std::string getStringFromVtkMatrix(vtkMatrix4x4* mat);
  std::string getStringFromActorMatrix();
  void setRendererAndActorFromMain(vtkSmartPointer<vtkRenderer> rend, vtkSmartPointer<vtkActor> act);
  double* getMatrixTab();

  void TwoFingerInteraction();
