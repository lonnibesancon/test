...
/*=========================================================================
  ...
  Module:    myImplicitPlaneRepresentation.h
...
=========================================================================*/
// .NAME myImplicitPlaneRepresentation - a class defining the representation for a vtkImplicitPlaneWidget2
// .SECTION Description
...
#ifndef myImplicitPlaneRepresentation_h
#define myImplicitPlaneRepresentation_h
...
class vtkLookupTable;
	...
	//class VTKINTERACTIONWIDGETS_EXPORT myImplicitPlaneRepresentation : public vtkWidgetRepresentation
class myImplicitPlaneRepresentation : public vtkWidgetRepresentation
{
public:
	// Description:
	// Instantiate the class.
	static myImplicitPlaneRepresentation *New();

	// Description:
	// Standard methods for the class.
	vtkTypeMacro(myImplicitPlaneRepresentation,vtkWidgetRepresentation);
	...
	//Set of functions to hide/show the outline, had to add them because it was not doable with the classic vtk class
	void HideOutline();
	void ShowOutline();
	void SetMatrix(vtkSmartPointer<vtkMatrix4x4> mat);
...
private:
	myImplicitPlaneRepresentation(const myImplicitPlaneRepresentation&);  //Not implemented
	void operator=(const myImplicitPlaneRepresentation&);  //Not implemented
};
#endif
