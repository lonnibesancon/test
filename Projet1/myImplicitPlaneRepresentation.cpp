//Had to reimplement it to add a method to hide the outline


/*=========================================================================
  Program:   Visualization Toolkit
  Module:    myImplicitPlaneRepresentation.cxx
...
vtkStandardNewMacro(myImplicitPlaneRepresentation);

//----------------------------------------------------------------------------
myImplicitPlaneRepresentation::myImplicitPlaneRepresentation()
{
  ...
  this->RepresentationState = myImplicitPlaneRepresentation::Outside;
}
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::SetLockNormalToCamera(int lock)
{
...
//----------------------------------------------------------------------------
int myImplicitPlaneRepresentation::ComputeInteractionState(int X, int Y,
                                                            int vtkNotUsed(modify))
{
  ...
  if ( path == NULL ) // Not picking this widget
    {
    this->SetRepresentationState(myImplicitPlaneRepresentation::Outside);
    this->InteractionState = myImplicitPlaneRepresentation::Outside;
  ...
  if ( this->InteractionState == myImplicitPlaneRepresentation::Moving )
    {
    vtkProp *prop = path->GetFirstNode()->GetViewProp();
    if ( prop == this->ConeActor || prop == this->LineActor ||
         prop == this->ConeActor2 || prop == this->LineActor2 )
      {
      this->InteractionState = myImplicitPlaneRepresentation::Rotating;
      this->SetRepresentationState(myImplicitPlaneRepresentation::Rotating);
      }
      ...
      if(this->LockNormalToCamera)
        ...
        {
        this->InteractionState = myImplicitPlaneRepresentation::Pushing;
        this->SetRepresentationState(myImplicitPlaneRepresentation::Pushing);
        }
      }
    else if ( prop == this->SphereActor )
      {
      this->InteractionState = myImplicitPlaneRepresentation::MovingOrigin;
      this->SetRepresentationState(myImplicitPlaneRepresentation::MovingOrigin);
      }
    else
      {
      if ( this->OutlineTranslation )
        {
        this->InteractionState = myImplicitPlaneRepresentation::MovingOutline;
        this->SetRepresentationState(myImplicitPlaneRepresentation::MovingOutline);
        }
      else
        {
        this->InteractionState = myImplicitPlaneRepresentation::Outside;
  ...
  else if ( this->InteractionState != myImplicitPlaneRepresentation::Scaling )
    {
    this->InteractionState = myImplicitPlaneRepresentation::Outside;
    }
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::SetRepresentationState(int state)
{
  ...
  // Clamp the state
  state = (state < myImplicitPlaneRepresentation::Outside ?
           myImplicitPlaneRepresentation::Outside :
           (state > myImplicitPlaneRepresentation::Scaling ?
            myImplicitPlaneRepresentation::Scaling : state));

  this->RepresentationState = state;
  this->Modified();

  if ( state == myImplicitPlaneRepresentation::Rotating )
    {
    this->HighlightNormal(1);
    this->HighlightPlane(1);
    }
  else if ( state == myImplicitPlaneRepresentation::Pushing )
    {
    this->HighlightNormal(1);
    this->HighlightPlane(1);
    }
  else if ( state == myImplicitPlaneRepresentation::MovingOrigin )
    {
    this->HighlightNormal(1);
    }
  else if ( state == myImplicitPlaneRepresentation::MovingOutline )
    {
    this->HighlightOutline(1);
    }
  else if ( state == myImplicitPlaneRepresentation::Scaling &&
            this->ScaleEnabled )
    {
    this->HighlightNormal(1);
    this->HighlightPlane(1);
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::StartWidgetInteraction(double e[2])
{
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::WidgetInteraction(double e[2])
{
  ...
  // Process the motion
  if ( this->InteractionState == myImplicitPlaneRepresentation::MovingOutline )
    {
    this->TranslateOutline(prevPickPoint, pickPoint);
    }
  else if ( this->InteractionState == myImplicitPlaneRepresentation::MovingOrigin )
    {
    this->TranslateOrigin(prevPickPoint, pickPoint);
    }
  else if ( this->InteractionState == myImplicitPlaneRepresentation::Pushing )
    {
  ...
  else if ( this->InteractionState == myImplicitPlaneRepresentation::Rotating )
    {
    camera->GetViewPlaneNormal(vpn);
    this->Rotate(e[0], e[1], prevPickPoint, pickPoint, vpn);
    }
  else if( this->InteractionState == myImplicitPlaneRepresentation::Outside &&
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::EndWidgetInteraction(double vtkNotUsed(e)[2])
{
  this->SetRepresentationState(myImplicitPlaneRepresentation::Outside);
}

//----------------------------------------------------------------------
double *myImplicitPlaneRepresentation::GetBounds()
{
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::GetActors(vtkPropCollection *pc)
{
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::ReleaseGraphicsResources(vtkWindow *w)
{
...
//----------------------------------------------------------------------------
int myImplicitPlaneRepresentation::RenderOpaqueGeometry(vtkViewport *v)
{
  int count=0;
  this->BuildRepresentation();
...
//-----------------------------------------------------------------------------
int myImplicitPlaneRepresentation::RenderTranslucentPolygonalGeometry(
  vtkViewport *v)
{
  int count=0;
  this->BuildRepresentation();
...
//-----------------------------------------------------------------------------
int myImplicitPlaneRepresentation::HasTranslucentPolygonalGeometry()
{
  int result=0;
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::HighlightNormal(int highlight)
{
  if ( highlight )
    {
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::HighlightPlane(int highlight)
{
  if ( highlight )
    {
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::HighlightOutline(int highlight)
{
  if ( highlight )
    {
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::Rotate(double X, double Y,
...
void myImplicitPlaneRepresentation::TranslateOutline(double *p1, double *p2)
{
...
//----------------------------------------------------------------------------
// Loop through all points and translate them
void myImplicitPlaneRepresentation::TranslateOrigin(double *p1, double *p2)
{
  //Get the motion vector
  double v[3];
  v[0] = p2[0] - p1[0];
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::Scale(double *p1, double *p2,
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::Push(double *p1, double *p2)
{
  //Get the motion vector
  double v[3];
  v[0] = p2[0] - p1[0];
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::CreateDefaultProperties()
{
  // Normal properties
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::SetEdgeColor(vtkLookupTable* lut)
{
  this->EdgesMapper->SetLookupTable(lut);
}

//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::SetEdgeColor(double r, double g, double b)
{
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::SetEdgeColor(double c[3])
{
  this->SetEdgeColor(c[0], c[1], c[2]);
}

//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::PlaceWidget(double bds[6])
{
  int i;
...
void myImplicitPlaneRepresentation::SetOrigin(double x, double y, double z)
{
  double origin[3];
  origin[0] = x;
  origin[1] = y;
...
void myImplicitPlaneRepresentation::SetOrigin(double x[3])
{
...
double* myImplicitPlaneRepresentation::GetOrigin()
{
  return this->Plane->GetOrigin();
}

//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::GetOrigin(double xyz[3])
{
...
void myImplicitPlaneRepresentation::SetNormal(double x, double y, double z)
{
  double n[3], n2[3];
  n[0] = x;
  n[1] = y;
...
// Description:
// Set the normal to the plane.
void myImplicitPlaneRepresentation::SetNormal(double n[3])
{
...
double* myImplicitPlaneRepresentation::GetNormal()
{
  return this->Plane->GetNormal();
}

//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::GetNormal(double xyz[3])
{
  this->Plane->GetNormal(xyz);
}

//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::SetDrawPlane(int drawPlane)
{
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::SetNormalToXAxis (int var)
{
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::SetNormalToYAxis (int var)
{
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::SetNormalToZAxis (int var)
{
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::GetPolyData(vtkPolyData *pd)
{
  pd->ShallowCopy(this->Cutter->GetOutput());
}

//----------------------------------------------------------------------------
vtkPolyDataAlgorithm *myImplicitPlaneRepresentation::GetPolyDataAlgorithm()
{
  return this->Cutter;
}

//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::GetPlane(vtkPlane *plane)
{
  if ( plane == NULL )
    {
    return;
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::SetPlane(vtkPlane *plane)
{
  if ( plane == NULL )
    {
    return;
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::UpdatePlacement()
{
  this->Outline->Update();
  this->Cutter->Update();
  this->Edges->Update();
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::BumpPlane(int dir, double factor)
{
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::PushPlane(double d)
{
  this->Plane->Push(d);
  this->BuildRepresentation();
}
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::BuildRepresentation()
{
  if ( ! this->Renderer )
    {
    return;
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::SizeHandles()
{
  double radius =
...
//----------------------------------------------------------------------------
void myImplicitPlaneRepresentation::SetNormalToCamera()
{
  if( !this->Renderer )
    {
    return;
...
//----------------------------------------------------------------------
void myImplicitPlaneRepresentation::RegisterPickers()
{
...
void myImplicitPlaneRepresentation::HideOutline(){
	cout << "HIDE OUTLINE" << endl ;
	this->OutlineActor->SetVisibility(0);
	this->OutlineActor->VisibilityOff();
	this->OutlineActor->GetProperty()->SetLineWidth(0.01);
}
void myImplicitPlaneRepresentation::ShowOutline(){
	this->OutlineActor->SetVisibility(1);
}

void myImplicitPlaneRepresentation::SetMatrix(vtkSmartPointer<vtkMatrix4x4> mat){
	this->OutlineActor->SetUserMatrix(mat);
}